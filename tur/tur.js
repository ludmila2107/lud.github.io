...
let cards = [
    ...
    },
    {
        ...
        alt: 'Родос',
        title: 'Родос',
        descr: 'Остров рыцарей. Средневековые стены, построенные рыцарями Святого Иоанна, окружающие Старый город и прекрасные Византийские  церквm.',
        price: 1000,
        category: {
            id: 'weekend',
    ...
    },
    {
        ...
        alt: 'Корфу',
        title: 'Корфу',
        descr: 'Один из самых дорогих греческих курортов. Здесь множество маленьких бухт и заливов.',
        price: 3000,
        category: {
            id: 'beach',
            name: 'Пляжные'
    ...
    {
        src: 'img/santorini1.jpg',
        alt: 'Санторини',
        title: 'Санторини',
        descr: 'Черный песок на вулканических пляжах, голубые и синие купола церквей, белоснежные стены домов. Не отпуск, а сказка.',
        price: 10000,
        category: {
            id: 'beach',
            name: 'Пляжные'
    ...
    },
    {
        ...
        alt: 'Закинф',
        title: 'Закинф',
        descr: 'Этот ионический остров славится своей пышной растительностью, которая дала ему название «цветок Востока» (Фиоре ди Леванте).',
        price: 60000,
        category: {
            id: 'wedding',
            name: 'Свадебные'
    ...
    },
    {
        ...
        alt: 'Парос',
        title: 'Парос',
        descr: 'Это прекрасный курорт Киклад, славится традиционными часовнями, чистыми пляжами и захватывающей ночной жизнью.',
        price: 90000,
        category: {
            id: 'beach',
            name: 'Пляжные'
